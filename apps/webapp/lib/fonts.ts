 ...
 * system's theme. Inter is the workhorse: it holds up at the 11–12px the quote tables run at, where
 * the display face does not. Poppins is geometric like the wordmark and carries the heading scale,
 * which is why every text-heading-* utility sets the family itself.
 *
