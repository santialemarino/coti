...
INSERT INTO quote (id, account_id, number, branch_id, client_id, rfq_id, seller_id, current_status, expires_at, created_at) VALUES
  ('20000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 1, 'b0000000-0000-4000-8000-000000000001',
   'f0000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', NULL, 'DRAFT', NULL, now() - interval '3 hours'),
  ('20000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', 2, 'b0000000-0000-4000-8000-000000000001',
  ...
  ('20000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', 3, 'b0000000-0000-4000-8000-000000000001',
  ...
  ('20000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', 4, 'b0000000-0000-4000-8000-000000000001',
  ...
  ('20000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000001', 5, 'b0000000-0000-4000-8000-000000000002',
   NULL, '10000000-0000-4000-8000-000000000005', 'c0000000-0000-4000-8000-000000000001', 'DRAFT', NULL, now() - interval '40 minutes'),
  ('20000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000001', 6, 'b0000000-0000-4000-8000-000000000001',
...
VALUES ('a0000000-0000-4000-8000-000000000001', 6)
ON CONFLICT (account_id) DO UPDATE SET last_number = GREATEST(quote_number_counter.last_number, 6);

INSERT INTO quote_version (id, account_id, quote_id, author_id, version_number, total, is_immutable, frozen_at, comment, created_at) VALUES
  ('30000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', NULL, 1, 0.00, FALSE, NULL, NULL, now() - interval '3 hours'),
  ('30000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000002', 'c0000000-0000-4000-8000-000000000002', 1, 1325800.00, FALSE, NULL, 'Contrapiso con hidrófugo en el mezclado', now() - interval '2 days'),
  ('30000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000003', 'c0000000-0000-4000-8000-000000000002', 1, 964000.00, TRUE, now() - interval '5 days', NULL, now() - interval '5 days'),
  ('30000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000004', 'c0000000-0000-4000-8000-000000000002', 1, 369000.00, TRUE, now() - interval '8 days', NULL, now() - interval '8 days'),
  ('30000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000004', 'c0000000-0000-4000-8000-000000000002', 2, 539600.00, FALSE, NULL, 'El cliente sumó 10 bolsas de cemento y pidió hidrófugo', now() - interval '1 day'),
  ('30000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000005', 'c0000000-0000-4000-8000-000000000001', 1, 0.00, FALSE, NULL, NULL, now() - interval '40 minutes'),
  ('30000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000006', 'c0000000-0000-4000-8000-000000000002', 1, 178800.00, TRUE, now() - interval '90 minutes', NULL, now() - interval '90 minutes')
ON CONFLICT (id) DO NOTHING;
...
-- DRAFT items carry no prices — pricing only arrives on the DRAFT→QUOTED transition. A
-- quote the seller has priced (QUOTED onward) never leaves an unmatched item: they are flagged
-- with match_status NO_MATCH and product_id/price/subtotal NULL, never discarded.
INSERT INTO quote_item (id, account_id, version_id, product_id, requested_description, quantity, unit, unit_price_snapshot, min_price_snapshot, subtotal, confidence_score, match_status) VALUES
  ('40000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'd0000000-0000-4000-8000-000000000001', '50 bolsas de portland', 50, 'bolsa', NULL, NULL, NULL, 0.9600, 'MATCHED'),
  ('40000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'd0000000-0000-4000-8000-000000000006', '1000 huecos del 12', 1000, 'unidad', NULL, NULL, NULL, 0.9400, 'MATCHED'),
  ('40000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', 'd0000000-0000-4000-8000-000000000008', '10 hierros del 8', 10, 'barra', NULL, NULL, NULL, 0.9800, 'MATCHED'),
  ...
  ('40000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000002', 'd0000000-0000-4000-8000-000000000020', 'hidrófugo para el contrapiso', 2, 'balde', 18900.00, 16632.00, 37800.00, 0.8500, 'MATCHED'),
  ...
  ('40000000-0000-4000-8000-000000000015', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000006', 'd0000000-0000-4000-8000-000000000001', '10 bolsas de cemento', 10, 'bolsa', NULL, NULL, NULL, 1.0000, 'MATCHED'),
  ('40000000-0000-4000-8000-000000000016', 'a0000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000006', 'd0000000-0000-4000-8000-000000000006', '500 ladrillos huecos del 12', 500, 'unidad', NULL, NULL, NULL, 1.0000, 'MATCHED'),
...
-- A SENT quote the seller must chase: it surfaces first in the inbox (needs_followup DESC) and
-- is highlighted. The flag is a backend fact, so it is written here by hand. The WHERE keeps
-- the update idempotent: it only fires once and never rewrites a local edit.
UPDATE quote
SET needs_followup = TRUE, followup_flagged_at = now() - interval '3 hours'
WHERE id = '20000000-0000-4000-8000-000000000003' AND needs_followup = FALSE;

-- An ACCEPTED quote boxed away, so the inbox list proves archived rows are excluded.
UPDATE quote
SET archived_at = now() - interval '2 hours'
WHERE id = '20000000-0000-4000-8000-000000000006' AND archived_at IS NULL;
