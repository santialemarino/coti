...
- **Class scanning is monorepo-wide from inside the package.** `index.css` declares
  `@source "../../**/*.{ts,tsx}"` and `@source "../../../../apps/**/*.{ts,tsx}"`, so a
  class used only in an app is still generated.
